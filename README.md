# Awesome CMake [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 471,567 | 🐛 81 | 📅 2026-05-05 with stars
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,093 | 🐛 1,271 | 🌐 CMake | 📅 2026-05-30 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 12,969 | 🐛 402 | 🌐 C++ | 📅 2026-05-21 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,377 | 🐛 589 | 🌐 Python | 📅 2026-05-29 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,009 | 🐛 160 | 🌐 CMake | 📅 2026-05-30 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [cget](https://github.com/pfultz2/cget) ⭐ 462 | 🐛 52 | 🌐 Python | 📅 2026-04-03 - CMake package retrieval. This can be used to download and install CMake packages. [`[BOOST]`][BOOST]
...
* [extra-cmake-modules](https://github.com/KDE/extra-cmake-modules) ⭐ 151 | 🐛 0 | 🌐 CMake | 📅 2026-05-30 - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`][BSD-3-Clause]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 61 | 🐛 50 | 🌐 CMake | 📅 2025-07-17 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 593 | 🐛 248 | 🌐 C++ | 📅 2026-05-29 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [cmake-examples](https://github.com/ttroy50/cmake-examples) ⭐ 13,060 | 🐛 30 | 🌐 CMake | 📅 2024-02-28 - Useful CMake examples in a tutorial format. [`[MIT]`][MIT]
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,362 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,740 | 🐛 133 | 🌐 C++ | 📅 2026-05-19 and much more. [`[UNLICENSE]`][UNLICENSE]
* [cmake-cookbook](https://github.com/dev-cafe/cmake-cookbook) ⭐ 2,845 | 🐛 28 | 🌐 C++ | 📅 2021-06-01 - A huge CMake cookbook full of recipes. [`[MIT]`][MIT]
...
* [cmake\_templates](https://github.com/acdemiralp/cmake_templates) ⭐ 125 | 🐛 0 | 🌐 C++ | 📅 2026-05-27 - Templates for creating C++ libraries and executables (including conan). `[NO LICENSE]`
...
* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 534 | 🐛 187 | 🌐 Python | 📅 2026-05-25 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
...
* [SoCMake](https://github.com/HEP-SoC/SoCMake) ⭐ 40 | 🐛 31 | 🌐 CMake | 📅 2026-05-28 - CMake based build system for hardware (ASIC, FPGA) and System-on-Chip build automation. [`[LGPL]`][LGPL]
...
* [cmakefmt](https://github.com/cmakefmt/cmakefmt) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-05-30 - Fast, native CMake formatter written in Rust with format-on-save editor support and a first-party GitHub Action. [`[MIT]`][MIT]
