# Awesome CMake [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 473,035 | 🐛 83 | 📅 2026-06-02 with stars
...
There is another file [`NonModernCMake.md`](origin/NonModernCMake.md) with other links worth taking a look, but they use obsolete practices which are considered non-modern - like not using `target_*`-based dependency management - see [`#16`](https://github.com/onqtam/awesome-cmake/issues/16) ⭐ 5,387 | 🐛 4 | 📅 2026-05-11 and [`#42`](https://github.com/onqtam/awesome-cmake/pull/42) ⭐ 5,387 | 🐛 4 | 📅 2026-05-11 for more details.
...
* [Modern CMake](https://github.com/toeb/moderncmake) ⭐ 245 | 🐛 2 | 🌐 CMake | 📅 2016-08-31 - Modern CMake **PDF** and samples by the creator of [cmakepp](https://github.com/toeb/cmakepp) ⭐ 446 | 🐛 40 | 🌐 CMake | 📅 2021-12-27. [`[MIT]`][MIT]
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,119 | 🐛 1,231 | 🌐 CMake | 📅 2026-06-05 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 12,989 | 🐛 402 | 🌐 C++ | 📅 2026-05-21 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,388 | 🐛 585 | 🌐 Python | 📅 2026-06-04 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,017 | 🐛 160 | 🌐 CMake | 📅 2026-06-02 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [fips](https://github.com/floooh/fips) ⭐ 508 | 🐛 58 | 🌐 Python | 📅 2026-01-26 - High-level build system/dependency management for distributed, multi-platform C/C++ projects. [`[MIT]`][MIT]
* [cget](https://github.com/pfultz2/cget) ⭐ 462 | 🐛 52 | 🌐 Python | 📅 2026-05-31 - CMake package retrieval. This can be used to download and install CMake packages. [`[BOOST]`][BOOST]
...
* [cmake-modules](https://github.com/rpavlik/cmake-modules) ⭐ 1,069 | 🐛 20 | 🌐 CMake | 📅 2025-02-10 - [Ryan Pavlik](https://github.com/rpavlik)'s collection of CMake modules. There are a number of find modules, especially for virtual reality and physical simulation, some utility modules, and some patches or workarounds for CMake itself. [`[BOOST]`][BOOST]
...
* [extra-cmake-modules](https://github.com/KDE/extra-cmake-modules) ⭐ 152 | 🐛 0 | 🌐 CMake | 📅 2026-06-03 - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`][BSD-3-Clause]
* [cgcmake](https://github.com/chadmv/cgcmake) ⭐ 132 | 🐛 1 | 🌐 CMake | 📅 2021-06-08 - CMake modules for common applications related to computer graphics. [`[MIT]`][MIT]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 61 | 🐛 50 | 🌐 CMake | 📅 2025-07-17 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 594 | 🐛 248 | 🌐 C++ | 📅 2026-06-03 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [CMake-codecov](https://github.com/RWTH-ELP/CMake-codecov) ⭐ 98 | 🐛 7 | 🌐 CMake | 📅 2026-04-03 - Enables code coverage and generates coverage reports with CMake targets. [`[GPL]`][GPL]
...
* [dockcross](https://github.com/dockcross/dockcross) ⭐ 3,586 | 🐛 6 | 🌐 Shell | 📅 2026-05-15 - Cross compiling toolchains in Docker images. [`[MIT]`][MIT]
* [android-cmake](https://github.com/taka-no-me/android-cmake) ⭐ 1,227 | 🐛 45 | 🌐 CMake | 📅 2018-02-16 - CMake toolchain file and other scripts for the Android NDK. [`[BSD3]`][BSD-3-Clause]
...
* [cmake-examples](https://github.com/ttroy50/cmake-examples) ⭐ 13,062 | 🐛 30 | 🌐 CMake | 📅 2024-02-28 - Useful CMake examples in a tutorial format. [`[MIT]`][MIT]
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,363 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,747 | 🐛 135 | 🌐 C++ | 📅 2026-05-19 and much more. [`[UNLICENSE]`][UNLICENSE]
...
* [pitchfork](https://github.com/vector-of-bool/pitchfork) ⭐ 1,245 | 🐛 42 | 🌐 C++ | 📅 2024-04-26 - A set of conventions for native C and C++ projects. [`[MIT]`][MIT]
* [cmake-examples](https://github.com/pr0g/cmake-examples) ⭐ 1,230 | 🐛 1 | 🌐 CMake | 📅 2025-02-22 - A collection of as simple as possible, modern CMake projects. [`[MIT]`][MIT]
* [cmake-init](https://github.com/cginternals/cmake-init) ⭐ 940 | 🐛 25 | 🌐 CMake | 📅 2025-04-14 - Template for reliable, cross-platform C++ project setup using CMake. [`[LICENSE]`](https://github.com/cginternals/cmake-init/blob/master/LICENSE) ⭐ 940 | 🐛 25 | 🌐 CMake | 📅 2025-04-14
* [modern-cmake-sample](https://github.com/pabloariasal/modern-cmake-sample) ⭐ 678 | 🐛 5 | 🌐 CMake | 📅 2021-03-18 - Best practices and proper usage of CMake by using targets. `[NO LICENSE]`
* [cpp-project](https://github.com/bsamseth/cpp-project) ⭐ 622 | 🐛 2 | 🌐 CMake | 📅 2023-09-19 - Boiler plate for C++ projects - tests, CI, coverage, docs. [`[UNLICENSE]`][UNLICENSE]
...
* [how-to-export-cpp-library](https://github.com/robotology/how-to-export-cpp-library) ⭐ 375 | 🐛 11 | 🌐 CMake | 📅 2021-01-13 - An OS-agnostic template project for exporting either shared, static or header-only C++ library, sporting ctest and CI support, written in plain CMake with line-by-line tutorial comments. [`[MIT]`][MIT]
...
* [cmake\_templates](https://github.com/acdemiralp/cmake_templates) ⭐ 129 | 🐛 1 | 🌐 CMake | 📅 2026-06-05 - Templates for creating C++ libraries and executables (including conan). `[NO LICENSE]`
...
* [SeeMake](https://github.com/MhmRhm/SeeMake) ⭐ 13 | 🐛 0 | 🌐 CMake | 📅 2026-03-26 - A feature-packed, ready-to-use CMake template with testing, static and dynamic checks, coverage reports, and more. [`[MIT]`][MIT]

## Other

* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 534 | 🐛 187 | 🌐 Python | 📅 2026-06-01 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
...
* [osg-3rdparty-cmake](https://github.com/bjornblissing/osg-3rdparty-cmake) ⭐ 199 | 🐛 10 | 🌐 CMake | 📅 2023-01-12 - CMake scripts for building OpenSceneGraph third party libraries. `[MIXED LICENSE]`
...
* [cmake-checks-cache](https://github.com/cristianadam/cmake-checks-cache) ⭐ 88 | 🐛 2 | 🌐 CMake | 📅 2022-03-04 - CMake checks cache helper modules. [`[MIT]`][MIT]
...
* [cmake-d](https://github.com/dcarp/cmake-d) ⭐ 65 | 🐛 4 | 🌐 CMake | 📅 2023-06-09 - CMake for D2. [`[MIT]`][MIT]
...
* [cmakefmt](https://github.com/cmakefmt/cmakefmt) ⭐ 17 | 🐛 5 | 🌐 Rust | 📅 2026-06-02 - Fast, native CMake formatter written in Rust with format-on-save editor support and a first-party GitHub Action. [`[MIT]`][MIT]
...
* [cmake-xray](https://github.com/pt9912/cmake-xray) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-05-13 - Analyze and diagnose CMake-based C++ builds from compile databases and CMake File API data. [`[MIT]`][MIT]
