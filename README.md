# Awesome CMake [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,649 | 🐛 67 | 📅 2026-01-28 with stars
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 26,584 | 🐛 1,349 | 🌐 CMake | 📅 2026-02-07 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 12,669 | 🐛 391 | 🌐 C++ | 📅 2026-01-20 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,216 | 🐛 783 | 🌐 Python | 📅 2026-02-05 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 3,886 | 🐛 156 | 🌐 CMake | 📅 2026-01-18 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [CMake](https://github.com/Eyescale/CMake) ⭐ 156 | 🐛 13 | 🌐 CMake | 📅 2023-12-05 - [Eyescale](https://github.com/Eyescale)'s common CMake modules. [`[BSD3]`][BSD-3-Clause]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 59 | 🐛 50 | 🌐 CMake | 📅 2025-07-17 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 585 | 🐛 246 | 🌐 C++ | 📅 2026-02-06 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [CMake-codecov](https://github.com/RWTH-ELP/CMake-codecov) ⭐ 95 | 🐛 10 | 🌐 CMake | 📅 2025-05-05 - Enables code coverage and generates coverage reports with CMake targets. [`[GPL]`][GPL]
...
* [dockcross](https://github.com/dockcross/dockcross) ⭐ 3,555 | 🐛 11 | 🌐 CMake | 📅 2026-02-03 - Cross compiling toolchains in Docker images. [`[MIT]`][MIT]
...
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,297 | 🐛 26 | 🌐 CMake | 📅 2025-03-12 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,607 | 🐛 169 | 🌐 C++ | 📅 2026-02-07 and much more. [`[UNLICENSE]`][UNLICENSE]
...
* [pitchfork](https://github.com/vector-of-bool/pitchfork) ⭐ 1,229 | 🐛 41 | 🌐 C++ | 📅 2024-04-26 - A set of conventions for native C and C++ projects. [`[MIT]`][MIT]
...
* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 527 | 🐛 191 | 🌐 Python | 📅 2026-01-26 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
...
* [cmake-language-server](https://github.com/regen100/cmake-language-server) ⭐ 399 | 🐛 22 | 🌐 Python | 📅 2025-02-11 - CMake Language Server Protocol Implementation. [`[MIT]`][MIT]
...
* [SoCMake](https://github.com/HEP-SoC/SoCMake) ⭐ 35 | 🐛 26 | 🌐 CMake | 📅 2026-01-30 - CMake based build system for hardware (ASIC, FPGA) and System-on-Chip build automation. [`[LGPL]`][LGPL]
