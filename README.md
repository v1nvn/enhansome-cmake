# Awesome CMake [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 472,174 | 🐛 82 | 📅 2026-05-05 with stars
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,102 | 🐛 1,257 | 🌐 CMake | 📅 2026-06-02 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 12,976 | 🐛 402 | 🌐 C++ | 📅 2026-05-21 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,382 | 🐛 585 | 🌐 Python | 📅 2026-06-02 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,010 | 🐛 160 | 🌐 CMake | 📅 2026-06-01 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [extra-cmake-modules](https://github.com/KDE/extra-cmake-modules) ⭐ 151 | 🐛 0 | 🌐 CMake | 📅 2026-06-02 - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`][BSD-3-Clause]
...
* [cmake-examples](https://github.com/ttroy50/cmake-examples) ⭐ 13,059 | 🐛 30 | 🌐 CMake | 📅 2024-02-28 - Useful CMake examples in a tutorial format. [`[MIT]`][MIT]
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,363 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,744 | 🐛 135 | 🌐 C++ | 📅 2026-05-19 and much more. [`[UNLICENSE]`][UNLICENSE]
...
* [pitchfork](https://github.com/vector-of-bool/pitchfork) ⭐ 1,246 | 🐛 42 | 🌐 C++ | 📅 2024-04-26 - A set of conventions for native C and C++ projects. [`[MIT]`][MIT]
...
* [cmake\_templates](https://github.com/acdemiralp/cmake_templates) ⭐ 125 | 🐛 4 | 🌐 C++ | 📅 2026-06-02 - Templates for creating C++ libraries and executables (including conan). `[NO LICENSE]`
...
* [SoCMake](https://github.com/HEP-SoC/SoCMake) ⭐ 40 | 🐛 30 | 🌐 CMake | 📅 2026-05-28 - CMake based build system for hardware (ASIC, FPGA) and System-on-Chip build automation. [`[LGPL]`][LGPL]
