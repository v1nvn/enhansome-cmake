# Awesome CMake [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 472,735 | 🐛 82 | 📅 2026-06-02 with stars
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 27,113 | 🐛 1,231 | 🌐 CMake | 📅 2026-06-04 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 12,985 | 🐛 402 | 🌐 C++ | 📅 2026-05-21 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,386 | 🐛 585 | 🌐 Python | 📅 2026-06-03 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 4,013 | 🐛 160 | 🌐 CMake | 📅 2026-06-02 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [extra-cmake-modules](https://github.com/KDE/extra-cmake-modules) ⭐ 151 | 🐛 0 | 🌐 CMake | 📅 2026-06-03 - [KDE](https://github.com/KDE)'s extra modules and scripts for CMake. [`[BSD3]`][BSD-3-Clause]
...
* [YCM](https://github.com/robotology/ycm) ⭐ 61 | 🐛 50 | 🌐 CMake | 📅 2025-07-17 - Extra CMake Modules for [Yet Another Robot Platform](https://github.com/robotology/yarp) ⭐ 593 | 🐛 248 | 🌐 C++ | 📅 2026-06-03 and friends. [`[BSD3]`][BSD-3-Clause]
...
* [dockcross](https://github.com/dockcross/dockcross) ⭐ 3,585 | 🐛 6 | 🌐 Shell | 📅 2026-05-15 - Cross compiling toolchains in Docker images. [`[MIT]`][MIT]
...
* [cmake-examples](https://github.com/ttroy50/cmake-examples) ⭐ 13,061 | 🐛 30 | 🌐 CMake | 📅 2024-02-28 - Useful CMake examples in a tutorial format. [`[MIT]`][MIT]
* [ModernCppStarter](https://github.com/TheLartians/ModernCppStarter) ⭐ 5,363 | 🐛 25 | 🌐 CMake | 📅 2026-05-30 - A template for modern C++ projects using CMake, CI, code coverage, clang-format, reproducible dependency management, tests using [doctest](https://github.com/onqtam/doctest) ⭐ 6,745 | 🐛 135 | 🌐 C++ | 📅 2026-05-19 and much more. [`[UNLICENSE]`][UNLICENSE]
...
* [cmake-examples](https://github.com/pr0g/cmake-examples) ⭐ 1,229 | 🐛 1 | 🌐 CMake | 📅 2025-02-22 - A collection of as simple as possible, modern CMake projects. [`[MIT]`][MIT]
...
* [cmake\_templates](https://github.com/acdemiralp/cmake_templates) ⭐ 129 | 🐛 4 | 🌐 CMake | 📅 2026-06-04 - Templates for creating C++ libraries and executables (including conan). `[NO LICENSE]`
