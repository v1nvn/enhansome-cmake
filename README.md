# Awesome CMake [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,607 | 🐛 85 | 📅 2026-03-09 with stars
...
* [vcpkg](https://github.com/Microsoft/vcpkg) ⭐ 26,813 | 🐛 1,284 | 🌐 CMake | 📅 2026-03-31 - A tool to acquire and build C++ open source libraries. Uses CMake internally as a build script language. [`[MIT]`][MIT]
* [Ninja](https://github.com/ninja-build/ninja) ⭐ 12,834 | 🐛 410 | 🌐 C++ | 📅 2026-03-27 - Build system that differs from others in two major respects: it is designed to have its input files generated by a higher-level build system (like CMake), and it is designed to run builds as fast as possible. [`[APACHE2]`][APACHE2]
* [conan](https://github.com/conan-io/conan) ⭐ 9,290 | 🐛 669 | 🌐 Python | 📅 2026-03-30 - Conan C++ Package Manager, implemented in Python and has a CMake integration backend. [`[MIT]`][MIT]
* [cpm](https://github.com/TheLartians/CPM) ⭐ 3,957 | 🐛 158 | 🌐 CMake | 📅 2026-01-18 - A setup-free CMake + git dependency manager. [`[MIT]`][MIT]
...
* [cmake-modules](https://github.com/rpavlik/cmake-modules) ⭐ 1,066 | 🐛 19 | 🌐 CMake | 📅 2025-02-10 - [Ryan Pavlik](https://github.com/rpavlik)'s collection of CMake modules. There are a number of find modules, especially for virtual reality and physical simulation, some utility modules, and some patches or workarounds for CMake itself. [`[BOOST]`][BOOST]
* [cmake-modules](https://github.com/bilke/cmake-modules) ⭐ 588 | 🐛 31 | 🌐 CMake | 📅 2026-03-25 - This is a collection of additional CMake modules. Most of them are from Ryan Pavlik. [`[BOOST]`][BOOST]
...
* [Arduino-CMake-Toolchain](https://github.com/a9183756-gh/Arduino-CMake-Toolchain) ⭐ 148 | 🐛 24 | 🌐 CMake | 📅 2023-02-24 - CMake toolchain for all official and 3rd party Arduino platforms. [`[MIT]`][MIT]
...
* [cmake-init](https://github.com/cginternals/cmake-init) ⭐ 936 | 🐛 25 | 🌐 CMake | 📅 2025-04-14 - Template for reliable, cross-platform C++ project setup using CMake. [`[LICENSE]`](https://github.com/cginternals/cmake-init/blob/master/LICENSE) ⭐ 936 | 🐛 25 | 🌐 CMake | 📅 2025-04-14
...
* [scikit-build](https://github.com/scikit-build/scikit-build) ⭐ 530 | 🐛 187 | 🌐 Python | 📅 2026-03-30 - Improved build system generator for CPython C extensions. [`[MIT]`][MIT]
...
* [SoCMake](https://github.com/HEP-SoC/SoCMake) ⭐ 37 | 🐛 28 | 🌐 CMake | 📅 2026-03-31 - CMake based build system for hardware (ASIC, FPGA) and System-on-Chip build automation. [`[LGPL]`][LGPL]
